...
{
    const Workload* tables[] = { kCoreWorkloads, kVoiceWorkloads, kMemWorkloads, kModWorkloads, kAblWorkloads };
    const int       counts[] = { kCoreCount,     kVoiceCount,     kMemCount,     kModCount,     kAblCount     };
    for (int t = 0; t < 5; ++t)
