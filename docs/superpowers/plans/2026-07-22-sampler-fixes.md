...
Erwartet: `F-04: ORGANIZE reaches the spawn position…` FAIL (Position irgendwo zufällig statt bei ~43 200). `F-04: MOD brings the sampler's scatter back` ist bereits GRÜN.
