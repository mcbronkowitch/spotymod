...
static const PanelCtl kParamCtls[] = {
    ...
    {ATTACK_A, WK_SMKNOB, {16.000f, 76.800f}, "ATK"},
    {DECAY_A, WK_SMKNOB, {29.000f, 76.800f}, "DEC"},
    {RES_A, WK_SMKNOB, {42.000f, 76.800f}, "RES"},
    {SUB_A, WK_SMKNOB, {55.000f, 76.800f}, "SUB"},
    {DETUNE_A, WK_SMKNOB, {68.000f, 76.800f}, "DTUN"},
    ...
    {ATTACK_B, WK_SMKNOB, {197.360f, 76.800f}, "ATK"},
    {DECAY_B, WK_SMKNOB, {184.360f, 76.800f}, "DEC"},
    {RES_B, WK_SMKNOB, {171.360f, 76.800f}, "RES"},
    {SUB_B, WK_SMKNOB, {158.360f, 76.800f}, "SUB"},
    {DETUNE_B, WK_SMKNOB, {145.360f, 76.800f}, "DTUN"},
    ...
    {COUPLE, WK_SMKNOB, {96.180f, 31.000f}, "COUPL"},
    {SCALE, WK_KNOBI, {106.680f, 31.000f}, "SCALE"},
    {DRIFT, WK_SMKNOB, {117.180f, 31.000f}, "DRIFT"},
    {SPOT, WK_SMBTN, {96.180f, 43.500f}, "SPOT"},
    {MASTER_DRIVE, WK_SMKNOB, {106.680f, 43.500f}, "DRIVE"},
    {SETTLE, WK_SMBTN, {117.180f, 43.500f}, "SETL"},
    {REV_SIZE, WK_SMKNOB, {96.180f, 59.500f}, "SIZE"},
    {REV_DECAY, WK_SMKNOB, {117.180f, 59.500f}, "DECAY"},
    {REV_TONE, WK_SMKNOB, {96.180f, 71.500f}, "TONE"},
    {REV_DIFF, WK_SMKNOB, {117.180f, 71.500f}, "DIFF"},
    {REV_MIX, WK_SMKNOB, {106.680f, 65.500f}, "MIX"},
    {TEMPO, WK_SMKNOB, {106.680f, 78.500f}, "TEMPO"},
};
static const PanelCtl kInputCtls[] = {
    {IN_L, WK_IN, {96.180f, 89.000f}, "IN L"},
    {IN_R, WK_IN, {117.180f, 89.000f}, "IN R"},
    {CLOCK, WK_IN, {106.680f, 89.000f}, "CLK"},
    {RESET, WK_IN, {106.680f, 101.500f}, "RST"},
};
static const PanelCtl kOutputCtls[] = {
    {OUT_L, WK_OUT, {96.180f, 101.500f}, "OUT L"},
    {OUT_R, WK_OUT, {117.180f, 101.500f}, "OUT R"},
...
static const PanelTxt kPanelTexts[] = {
    ...
    {{106.680f, 54.200f}, 2.20f, 0.50f, 0x656056, "ROOM"},
    {{106.680f, 125.900f}, 3.60f, 0.90f, 0x171713, "SPOTYMOD"},
};
} // namespace spkyvcv
